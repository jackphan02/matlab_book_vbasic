...
{
  /// <summary>
  /// The Plus class provides a CLS compliant, MWArray interface to the M-functions
  /// contained in the files:
  /// <newpara></newpara>
  /// C:\MatlabVB\Mfiles\WindowsFormMatrixAddition\myplus.m
  /// <newpara></newpara>
  /// deployprint.m
  /// <newpara></newpara>
  /// printdlg.m
  ...
  public class Plus : IDisposable
  {
    ...
    /// <summary>
    /// Constructs a new instance of the Plus class.
    /// </summary>
    public Plus()
    {
    }
