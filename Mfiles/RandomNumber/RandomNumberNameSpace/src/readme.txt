...
Local component with MWArray                    RandomNumberNameSpace.dll
Local component with native API                 RandomNumberNameSpaceNative.dll
...
RandomNumberNameSpace_overview.html - HTML overview documentation file for the generated 
                                      component. It contains the requirements for 
                                      accessing the component and for generating 
                                      arguments using the MWArray class hierarchy.

RandomNumberNameSpace.xml - This file contains the code comments for the 
                                      RandomNumberNameSpace component classes and 
                                      methods. Using a third party documentation tool, 
                                      this file can be combined with either or both of 
                                      the previous files to generate online documentation 
                                      for the RandomNumberNameSpace component.
