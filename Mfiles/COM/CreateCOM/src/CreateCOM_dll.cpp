...
extern mclComponentData __MCC_CreateCOM_component_data;
...
{
  __MCC_CreateCOM_component_data.path_to_component = path_to_component;
  mclComponentOptions* componentOptions = mclCreateComponentOptions(true, false, "", 
                                                                    ctfStream, 
                                                                    ctfStreamSize);
  bool bResult = mclInitializeComponentInstanceEx(inst, &__MCC_CreateCOM_component_data, 
...
{
  {
      &CLSID_MyCOM, CMyCOM::RegisterClass, CMyCOM::UnregisterClass, 
    CMyCOM::GetClassObject, "MyCOM", "CreateCOM.MyCOM", "CreateCOM.MyCOM.1_0"
  },
  {
    NULL, NULL, NULL, NULL, "", "", ""
  }
...
{
  return g_pModule->InitMain(objectmap, &LIBID_CreateCOM, 1, 0, hInstance, dwReason, pv);
}
