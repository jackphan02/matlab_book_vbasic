...
Local component with MWArray                    PolyInterpolationNameSpace.dll
Local component with native API                 PolyInterpolationNameSpaceNative.dll
...
PolyInterpolationNameSpace_overview.html - HTML overview documentation file for the 
...
PolyInterpolationNameSpace.xml - This file contains the code comments for the 
                                           PolyInterpolationNameSpace component classes 
                                           and methods. Using a third party documentation 
                                           tool, this file can be combined with either or 
                                           both of the previous files to generate online 
                                           documentation for the 
                                           PolyInterpolationNameSpace component.
