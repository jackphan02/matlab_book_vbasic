...
Local component with MWArray                    PlusNameSpace.dll
Local component with native API                 PlusNameSpaceNative.dll
...
PlusNameSpace_overview.html - HTML overview documentation file for the generated 
                              component. It contains the requirements for accessing the 
                              component and for generating arguments using the MWArray 
                              class hierarchy.

PlusNameSpace.xml - This file contains the code comments for the PlusNameSpace component 
