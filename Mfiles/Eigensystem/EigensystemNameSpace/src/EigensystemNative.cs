...
namespace EigensystemNameSpaceNative
{
  /// <summary>
  /// The Eigensystem class provides a CLS compliant, Object (native) interface to the
  ...
  public class Eigensystem : IDisposable
  {
    ...
    /// <summary>
    /// Provides a single output, 0-input Objectinterface to the myeig M-function.
    /// </summary>
    /// <remarks>
    /// </remarks>
    ...
    public Object myeig()
    {
      return mcr.EvaluateFunction("myeig", new Object[]{});
    }


    /// <summary>
    /// Provides a single output, 1-input Objectinterface to the myeig M-function.
    /// </summary>
    /// <remarks>
    /// </remarks>
    ...
    /// <summary>
    /// Provides the standard 0-input Object interface to the myeig M-function.
    /// </summary>
    /// <remarks>
    /// </remarks>
    ...
    /// arguments.</returns>
    ///
    public Object[] myeig(int numArgsOut)
    {
      return mcr.EvaluateFunction(numArgsOut, "myeig", new Object[]{});
    }


    /// <summary>
    /// Provides the standard 1-input Object interface to the myeig M-function.
    /// </summary>
    /// <remarks>
    /// </remarks>
    /// <param name="numArgsOut">The number of output arguments to return.</param>
    ...
    /// arguments.</returns>
    ///
    public Object[] myeig(int numArgsOut, Object A)
    {
