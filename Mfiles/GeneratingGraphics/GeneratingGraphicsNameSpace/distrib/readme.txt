...
Local component with MWArray                    GeneratingGraphicsNameSpace.dll
Local component with native API                 GeneratingGraphicsNameSpaceNative.dll
...
GeneratingGraphicsNameSpace_overview.html - HTML overview documentation file for the 
...
GeneratingGraphicsNameSpace.xml - This file contains the code comments for the 
                                            GeneratingGraphicsNameSpace component classes 
                                            ...
                                            GeneratingGraphicsNameSpace component.
