...
Local component with MWArray                    MatrixMultiplicationNameSpace.dll
Local component with native API                 MatrixMultiplicationNameSpaceNative.dll

* If the target machine does not have version 7.11 of 
  the MCR installed, include MCRInstaller.exe.

* Additionally, distribute MatrixMultiplicationNameSpace.ctf  
...
MWArray.xml - This file contains the code comments for the MWArray data conversion 
              ...
              C:\Program Files\MATLAB\R2009b\toolbox\dotnetbuilder\bin\win32\v2.0

MatrixMultiplicationNameSpace_overview.html - HTML overview documentation file for the 
                                              generated component. It contains the 
                                              requirements for accessing the component 
                                              and for generating arguments using the 
                                              MWArray class hierarchy.

MatrixMultiplicationNameSpace.xml - This file contains the code comments for the 
                                              MatrixMultiplicationNameSpace component 
                                              classes and methods. Using a third party 
                                              documentation tool, this file can be 
                                              combined with either or both of the 
                                              previous files to generate online 
...
MatrixMultiplicationNameSpace uses for successful execution of exported M functions. 
