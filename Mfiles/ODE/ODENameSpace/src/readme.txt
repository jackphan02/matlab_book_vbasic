...
Local component with MWArray                    ODENameSpace.dll
Local component with native API                 ODENameSpaceNative.dll
...
ODENameSpace_overview.html - HTML overview documentation file for the generated 
                             component. It contains the requirements for accessing the 
                             component and for generating arguments using the MWArray 
                             class hierarchy.

ODENameSpace.xml - This file contains the code comments for the ODENameSpace component 
