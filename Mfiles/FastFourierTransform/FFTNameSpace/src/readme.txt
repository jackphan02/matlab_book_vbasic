...
Local component with MWArray                    FFTNameSpace.dll
Local component with native API                 FFTNameSpaceNative.dll
...
FFTNameSpace_overview.html - HTML overview documentation file for the generated 
                             component. It contains the requirements for accessing the 
                             component and for generating arguments using the MWArray 
                             class hierarchy.

FFTNameSpace.xml - This file contains the code comments for the FFTNameSpace component 
